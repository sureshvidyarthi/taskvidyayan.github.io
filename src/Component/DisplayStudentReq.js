                ...
                return(
                    <div >
                      <Paper elevation={3} className={classes.paperstyle}>
                        ...
                        <Divider />
                        <div  style={{display:'flex',justifyContent:'center',alignItems:'center',backgroundColor:'#f1f2f6',padding:5 }}>
                         <Button style={{backgroundColor:"#ff6c00",color:'#fff',borderRadius:'20px',fontWeight:"bold",marginRight:30}}>Accpet</Button>
                         <Button style={{backgroundColor:"#ff6c00",color:'#fff',borderRadius:'20px',fontWeight:"bold"}}>Delect</Button>
                        </div>
  ...
  return(
     ...
     <div className={classes.root} >
        ...
        <div style={{display:'flex',flexDirection:'column'}} >
            ...
            <Divider style={{color:'#000',background:"#000",width:330,marginTop:'-10px'}}/>
